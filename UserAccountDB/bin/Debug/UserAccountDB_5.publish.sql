/*
Deployment script for UserAccountDBO
...
GO
:setvar DatabaseName "UserAccountDBO"
:setvar DefaultFilePrefix "UserAccountDBO"
...
AS
BEGIN
	SELECT * from AccountInfo where Email=@Email and Password=@Password   
end
GO
